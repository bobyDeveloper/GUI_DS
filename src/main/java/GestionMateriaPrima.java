 ...
 * @author Ville
 */
public class GestionMateriaPrima extends javax.swing.JFrame {

    /**
     * Creates new form Productos
     */
    public GestionMateriaPrima() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionMateriaPrima.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionMateriaPrima().setVisible(true);
            }
        });
    }
